...
2) Atenção: a OC da Daju pode chegar com a data de entrega incompleta (sem o dia). Quando isso acontecer, o campo vem vazio no preview — confira e preencha a data antes de confirmar a importação.
...
> Versões anteriores a 20260725-1634 não têm notas registradas: até aqui elas
> viviam em `RELEASE_NOTES.txt`, sobrescrito a cada build. O histórico delas
> está no git.
